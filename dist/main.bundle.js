...
exports.ROUTES = [
    ...
    {
        path: 'detail', loadChildren: function () { return __webpack_require__.e/* System.import */(0).then(__webpack_require__.bind(null, "./src/app/+detail/index.ts")).then(function (mod) { return mod.__esModule ? mod.default : mod; }); }
    },
